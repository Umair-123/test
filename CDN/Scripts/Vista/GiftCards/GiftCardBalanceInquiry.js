...
Vista.GiftCards.GiftCardBalanceInquiry = (function () {
    'use strict';
    ...
    function setupEventHandlers() {
        ...
        giftCardBalanceForm.submit(function () {
            ...
            $.ajax({
                type: 'POST', // must be POST to prevent caching the result
    ...
    function resetInquiryResults() {
        // reset fields
        resultsStateContainer.find('.gift-card-number').text('');
        resultsStateContainer.find('.gift-card-balance').text('');
        resultsStateContainer.find('.gift-card-expiry').text('');
    };
...
$(Vista.GiftCards.GiftCardBalanceInquiry.init);