<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="visConcessionContents.aspx.vb" Inherits="visInternetTicketing.visConcessionContents" %>
...
<HTML>
	...
	<body class="FormStandard">
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="tblConcessionInfo" runat="server">
            </asp:table>
